   				...
   				while($row = $result_page->fetch_assoc()) {
   					...
   					<li class="a1">
   						<dl>
   							<!-- <dt>热门</dt> -->
   							<dd>
   								<a href="goods.php?id=<?php echo $row["id"]; if($flag==1){ echo '&uid=' .$uid; } ?>">
   									<?php
   								echo $row["goods_name"];
   								 ?>
   								</a>
   		...
   		while($row = $result_page->fetch_assoc()) {
   			?>
   				<li class="col-md-4 col-lg-4 col-sm-12">
   					<div class="thumbnail"><a href="goods.php?id=<?php echo $row["id"]; if($flag==1){ echo '&uid=' .$uid; } ?>"><img
   							 src="<?php echo $row['picture']?>"></a></div>
   					<div class="caption">
   			...
   			<div class="pagination col-lg-4 col-md-4 ">
   				<div class="pull-left pagination-detail">
   					<span class="pagination-info">
   						总共<span style="color:#00f;">
   							<?php echo $total_records ?></span>条记录；
   					</span>
   					<span class="page-list">每页显示
   						<?php echo $num_rec_per_page ?>条记录</span>
   				</div>
   			</div>
